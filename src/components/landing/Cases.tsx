...
const cases: Case[] = [
  {
    ...
    rate: "1 ¥ = 11.45 ₽ · +0.7%",
    solution:
      "Перевели расчёты на сопровождение Pay to China .ru с фиксированной комиссией и поэтапными выплатами.",
    metrics: [
...
export function Cases() {
  return (
    <section id="cases" className="relative overflow-hidden py-14 lg:py-20">
      <div
